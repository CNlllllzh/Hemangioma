...
def files_mask2rle(path):
    ...
    csv = open(r'result/predict2.csv', 'w')
...
if __name__ == '__main__':
    #files_rle2mask(r'D:\\PyCharm\\PyCode\\Hemangioma\\Data\\train_dataset\\mask.csv', 'D:\\PyCharm\\PyCode\\Hemangioma\\Data\\train_dataset\\mask')
    files_mask2rle('D:\\PyCharm\\PyCode\\Hemangioma\\result\\img')
